...
// const tCel = parseFloat(prompt("Введите температуру в градусах Цельсия"));
const tCel = Number.parseFloat(prompt("Введите температуру в градусах Цельсия"));
const tFar = (9 / 5) * tCel + 32;
alert(`Цельсий: ${tCel}, Фарангейт: ${tFar.toFixed(2)}`); //сейчас значение в Фаренгейтах он выводит как текст, можно добавить + перед переменной и тогда переменная будет численным значением. Значение 2 у метода toFixed означает до какого знака округлять